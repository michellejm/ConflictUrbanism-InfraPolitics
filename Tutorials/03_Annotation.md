...
We have provided the basic folder structure that you will need to create your webmap, in the `Data/3_Webmaps` folder downloaded with this repository. Lets review the structure before we proceed. It contains three folders and one file: 
